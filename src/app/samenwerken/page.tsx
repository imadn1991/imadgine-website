...
export default function SamenwerkenPage() {
  return (
    <div className="min-h-screen relative">
      ...
      {/* Hero */}
      <section className="px-6 md:px-12 py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-start relative z-10">
      ...
      {/* Method */}
      <section className="bg-on-surface text-surface py-24 px-6 md:px-12 relative overflow-hidden z-10">
        ...
        <div className="max-w-4xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 font-body text-lg opacity-90">
            <p>
              Geen dikke rapporten die in een lade verdwijnen. Ik graaf diep in
              de architectuur van je organisatie of project om de blokkades te
              vinden die vooruitgang in de weg staan.
            </p>
            <p>
      ...
      {/* Services */}
      <section className="px-6 md:px-12 py-24 bg-surface relative z-10">
        <div className="mb-16 flex justify-between items-end border-b-4 border-on-surface pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2 ink-border-medium p-8 flex flex-col justify-between group hover:bg-primary-container transition-colors duration-300">
            <div>
              ...
              <p className="font-body group-hover:text-white opacity-80">
                Wanneer de koers onduidelijk is geworden door ruis. We strippen
                de strategie tot de essentie en bouwen een nieuw, robuust plan.
              </p>
            </div>
          ...
          {/* Service 2 */}
          <div className="md:col-span-2 ink-border-medium p-8 flex flex-col justify-between group hover:bg-on-surface hover:text-surface transition-colors duration-300">
            <div>
          ...
          <div className="md:col-span-1 ink-border-medium p-8 bg-surface-container-high flex flex-col group hover:-translate-y-1 transition-transform">
            ...
            <p className="text-sm font-body mb-8 opacity-70">
              Een kritische blik op lopende trajecten. Waar lekt energie en waar
              ligt de onbenutte potentie?
            </p>
          ...
          <div className="md:col-span-3 ink-border-medium p-8 flex items-center gap-12 group hover:bg-primary-container transition-all">
            <div className="flex-1">
              ...
              <p className="font-body mt-4 group-hover:text-white opacity-80">
                ...
                Een filter voor je wildste ideeën en een spiegel voor je blinde
                vlekken.
              </p>
            </div>
            <div className="hidden md:block w-32 h-32 bg-on-surface overflow-hidden flex-shrink-0">
              <img
                alt="Detail"
                className="w-full h-full object-cover grayscale brightness-50"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDXj2w23tAbYguV-ddFXheCdpPHNpR-Eh4l3vOevYhcAOZrlVHd_hVLUvL6r5HmEuZmogA_q49NxXY6o71I_R0MDNGMyl53c6VnNNMU4xzMbCsmAzl1C9MkbyxpRbAp4Bpukm5AtGWbtrL0Y8hRWSS4OtQn5b6IczVHKeF3wTizzWHWK-OoHABqDnt0tOJegrh88FQe8aI1WT87vj9nTSVL3XedMv3MX-ROCivOQddz6zPgMNuYqAYTGM5_WG3QVnsOc6tNQSiyOYA"
              />
            </div>
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="px-6 md:px-12 py-32 flex flex-col items-center text-center relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-primary text-white text-xl font-label font-bold uppercase px-12 py-6 hard-shadow hard-shadow-hover transition-all"
            >
              Start een gesprek
            </a>
            <Link
              href="/denken"
              className="bg-surface text-on-surface border-4 border-on-surface text-xl font-label font-bold uppercase px-12 py-6 hard-shadow hard-shadow-hover transition-all"
            >
              Download Manifesto
            </Link>
          </div>
