  ...
  return (
    <div className="relative">
      ...
      <div className="w-full max-w-7xl mx-auto px-8 py-20 relative z-10">
        {/* Header */}
        <header className="mb-24 border-l-8 border-orange pl-8">
          <p className="font-label text-sm tracking-widest uppercase mb-4 text-orange">
          ...
          <h1 className="text-7xl md:text-9xl font-headline font-black uppercase leading-[0.85] tracking-tighter mb-8">
            HET <span className="text-orange">STRAAT</span>
            <br />
            PERSPECTIEF.
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-32">
          {/* Project 1: Overvecht als Spiegel */}
          <div className="md:col-span-8 group relative bg-white border-4 border-ink overflow-hidden ink-bleed-shadow transition-transform hover:-translate-y-1">
            ...
            <div className="p-8">
              ...
              <h2 className="text-4xl font-headline font-black uppercase mb-4 group-hover:text-orange transition-colors">
                Overvecht als Spiegel
              </h2>
              <p className="font-body text-lg opacity-80 max-w-xl">
                Een diepgravend kwalitatief onderzoek naar de geleefde
                ervaringen en de ongeschreven codes van de wijk Overvecht.
              </p>
            </div>
            <div className="absolute top-4 right-4 flex items-center justify-center w-12 h-12 bg-orange border-2 border-ink">
          ...
          {/* Project 2: Systeemwereld vs Leefwereld */}
          <div className="md:col-span-4 group relative bg-surface border-4 border-ink p-8 flex flex-col justify-between ink-bleed-shadow">
            <div>
              <div className="mb-12">
                <span className="font-label text-xs font-bold px-3 py-1 bg-orange text-white tracking-tighter">
                  STRATEGIE
                </span>
              </div>
            ...
            <div className="aspect-square border-2 border-ink overflow-hidden grayscale mix-blend-multiply opacity-70">
              <img
                alt="Strategie"
          ...
          {/* Project 3: De Weg van de Held */}
          <div className="md:col-span-5 group relative bg-ink text-paper border-4 border-ink p-8 flex flex-col justify-between shadow-[8px_8px_0px_0px_#ff5f1f]">
            <div className="mb-8">
              ...
              <p className="font-body opacity-70 text-lg">
                Intensieve trajectcoaching voor young professionals in de
                publieke sector gericht op persoonlijk leiderschap en
          ...
          {/* CTA Card */}
          <div className="md:col-span-7 group relative bg-orange border-4 border-ink p-12 overflow-hidden flex items-center justify-center">
            ...
            <div className="relative text-center">
              ...
              <Link
                href="/samenwerken"
                className="inline-block bg-ink text-white px-8 py-4 font-label font-bold uppercase tracking-tighter hover:opacity-90 transition-all"
              >
                Laten we praten
              </Link>
            </div>
        ...
        <section className="border-t-4 border-ink pt-16 flex flex-col md:flex-row gap-16">
          <div className="md:w-1/3">
            <h4 className="font-label text-xs font-bold uppercase tracking-widest text-orange mb-6">
              METHODIEK_04
            </h4>
            <p className="font-body font-bold text-2xl uppercase tracking-tighter leading-tight">
              De stad is geen Excel-sheet. Het is een levend organisme dat
              vraagt om radicale eerlijkheid.
            </p>
          </div>
          <div className="md:w-2/3 grid grid-cols-2 gap-8 font-label text-sm">
            <div className="border-l border-ink/20 pl-6">
              ...
              <p className="opacity-60">
                Wij gaan verder dan de standaard enquêtes en praten met de
                stemmen die vaak ongehoord blijven.
              </p>
            </div>
            <div className="border-l border-ink/20 pl-6">
