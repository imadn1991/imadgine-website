...
export default function OverPage() {
  return (
    <div className="relative">
      <div className="fixed inset-0 stipple z-0 opacity-30 pointer-events-none" />

      {/* Hero */}
      <section className="relative border-b-4 border-on-surface grid grid-cols-1 md:grid-cols-12 min-h-[600px]">
        <div className="md:col-span-7 p-8 md:p-16 flex flex-col justify-end gap-6 bg-surface z-10">
        ...
        <div className="md:col-span-5 relative bg-on-surface overflow-hidden min-h-[400px] md:min-h-full">
          <img
            alt="Overvecht Utrecht"
          ...
          <div className="absolute bottom-6 right-6 bg-on-surface p-4 border border-surface text-surface font-label text-[10px] uppercase tracking-tighter leading-none">
      ...
      {/* Story columns */}
      <section className="p-8 md:p-20 grid grid-cols-1 md:grid-cols-3 gap-12 border-b-4 border-on-surface relative z-10 bg-surface">
        <div className="flex flex-col gap-4">
          <h3 className="font-headline text-3xl font-extrabold uppercase border-b-2 border-on-surface pb-2">
            De Oorsprong
          </h3>
          <p className="font-body text-lg leading-relaxed">
            Opgegroeid in de rauwe maar warme omgeving van{" "}
            <strong>Overvecht</strong>, Utrecht. Hier leerde ik dat kansen niet
            worden gegeven, maar gecreëerd. Het trapveldje was mijn eerste
            klaslokaal. Daar leerde ik over hiërarchie, teamspirit en het belang
            van een scherpe blik.
          </p>
          <div className="mt-4 p-4 bg-surface-container-low border-2 border-on-surface hard-shadow">
            ...
            <p className="font-body text-sm italic">
              &quot;Je bent zo goed als je laatste pass.&quot;
            </p>
          </div>
        </div>
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-4 p-4 bg-primary-container text-on-primary-container border-2 border-on-surface hard-shadow">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="font-body text-lg leading-relaxed">
            IMADGINE is niet zomaar een bureau; het is een manifest. Wij werken
            voor de makers, de doeners en de dromers die begrijpen dat innovatie
            pijn moet doen om te kunnen groeien. Wij brengen de menselijke
            warmte terug in een kille, digitale wereld.
          </p>
          <div className="mt-auto pt-8">
            <img
              alt="Vintage newspaper texture"
              className="w-full h-32 object-cover border-2 border-on-surface grayscale"
      ...
      {/* Credentials */}
      <section className="bg-on-surface text-surface p-8 md:p-20 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="md:col-span-2 border-2 border-surface p-8 bg-surface text-on-surface hover:bg-primary-container hover:text-white transition-colors duration-300">
            ...
            <p className="font-body text-sm">
              Executive Education in Public Leadership. Het snijvlak van macht,
              moraal en maatschappelijke impact.
            </p>
            <div className="mt-8 flex justify-end">
              <span className="material-symbols-outlined text-4xl">school</span>
            </div>
          </div>
          <div className="md:col-span-1 border-2 border-surface p-8 flex flex-col justify-between">
            <div>
              <span className="font-label text-xs uppercase opacity-60">
                Innovation
              </span>
          ...
          <div className="md:col-span-1 border-2 border-surface p-8 flex flex-col justify-between bg-primary">
            <div>
              <span className="font-label text-xs uppercase opacity-60">
                Ethics
              </span>
              <h4 className="font-headline text-2xl font-black uppercase mt-4 text-surface">
                Ethical Leadership Academy
              </h4>
            </div>
            <p className="font-body text-xs opacity-90 mt-4">
              Besluitvorming geworteld in integriteit en menselijke maat.
            </p>
          </div>
          <div className="md:col-span-4 h-64 relative border-2 border-surface overflow-hidden">
            <img
              alt="Utrecht Oudegracht bij nacht"
              className="absolute inset-0 w-full h-full object-cover grayscale brightness-50"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDk48d7OKLl7UJXVAEiWZVROQbMl9T-tTm2D5koMHJTKS_DRTk9JuFG7BTOf2RH4WvPgYfAhlFbIOA2VLjnP_HX1ypToZqqvCiF9oa4yICiDypwseNgQR2m7Sb_7Q78CDehK3reep8YNJ6lSCe0K2zdYm0e_hKA-89iRKMp_3227mxGiNA6SXiL9BGB7jQl1803HM4UrFfyNJ-XwQkiMMqxyRiBsjGSSnrLH5qxlSYWkOx3SzOMXav7xblA"
            />
      ...
      {/* CTA */}
      <section className="bg-surface border-y-4 border-on-surface py-24 px-8 overflow-hidden relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <Link
              href="/samenwerken"
              className="bg-on-surface text-surface px-10 py-5 font-label font-bold uppercase text-lg border-2 border-on-surface hard-shadow active-shift flex items-center gap-4"
            >
              START EEN PROJECT
            ...
            <Link
              href="/denken"
              className="bg-transparent text-on-surface px-10 py-5 font-label font-bold uppercase text-lg border-4 border-on-surface hard-shadow active-shift"
            >
              LEES HET MANIFESTO
            </Link>
          </div>
